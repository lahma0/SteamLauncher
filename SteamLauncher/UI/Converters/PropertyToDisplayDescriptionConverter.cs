...
{
    //public class PropertyToDisplayDescriptionConverter : MarkupExtension, IValueConverter
    //{
    ...
    //        return ((DisplayAttribute)property.GetCustomAttributes(typeof(DisplayAttribute), true)[0]).Description;
    //    }
