...
namespace SteamLauncher.SteamClient.Interop
{
    ...
    //{
    //    protected SteamInterfaceWrapper(IntPtr interfacePtr, bool useOldVtableIndex=false)
    //    {
    ...
    //        UseOldVtableIndex = useOldVtableIndex;
    //    }

    //    /// <summary>
    //    /// Defines whether this interface should use 'OldIndex' when available as defined in the 'VTableIndex' attribute.
    //    /// </summary>
    //    protected bool UseOldVtableIndex { get; }
    ...
    //    {
    //        // Instead of getting vtable index from the attribute, we can just get it from our vtable offsets file
    //        var vtableIndex = ((VTableIndex)d.GetCustomAttribute(typeof(VTableIndex))).GetIndex(UseOldVtableIndex);
    //        var functionPtr = Marshal.ReadIntPtr(VTablePtr, vtableIndex * IntPtr.Size);
    ...
    //    ///// <summary>
    //    ///// Converts a UTF-8 string stored at the provided pointer into a normal string object. This is needed because
    //    ///// Steam stores strings in UTF-8.
    //    ///// </summary>
