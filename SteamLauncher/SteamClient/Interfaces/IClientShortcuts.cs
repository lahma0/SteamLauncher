...
namespace SteamLauncher.SteamClient.Interfaces
{
    ...
    public class IClientShortcuts : SteamInterfaceWrapper
    {
        ...
        [VTableIndex(27), UnmanagedFunctionPointer(CallingConvention.ThisCall, CharSet = CharSet.Ansi)]
        ...
        [VTableIndex(28), UnmanagedFunctionPointer(CallingConvention.ThisCall, CharSet = CharSet.Ansi)]
        ...
        [VTableIndex(36), UnmanagedFunctionPointer(CallingConvention.ThisCall)]
