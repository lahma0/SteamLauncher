...
namespace SteamLauncher.Tools
{
    public static class ProcessCommandLine
    {
        ...
        public static IReadOnlyList<string> CommandLineToArgsList(string commandLine)
        {
        ...
        public static string CommandLineToArgsString(string commandLine)
        {
            ...
            if (argIndex != -1)
            {
                return commandLine.Substring(argIndex + 1);
            }
