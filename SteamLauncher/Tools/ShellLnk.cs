...
{
    public class ShellLnk : IDisposable
    {
        ...
        private ShellLink _shellLinkObject;

        #region Constructors

        public ShellLnk()
        {
            _shellLinkObject = new ShellLink();
            _shellLink = _shellLinkObject as IShellLinkW;
        }

        public ShellLnk(string filename)
            : this()
        {
            if (File.Exists(filename))
            {
                ((IPersistFile)_shellLink).Load(filename, STGM_READ);
            }
        }
        ...
        public string Arguments
        {
            ...
            set => _shellLink.SetArguments(value);
        }
        ...
        public string TargetPath
        {
            get
            {
                ...
                //_shellLink.GetPath(sb, sb.Capacity, out findData, SLGP_FLAGS.SLGP_RAWPATH); // Doesn't resolve env vars
                _shellLink.GetPath(sb, sb.Capacity, out findData, 0); // Does resolve env vars
                return sb.ToString();
            }

            set => _shellLink.SetPath(value);
        }
        ...
        public static ShellLnk CreateShortcut(string linkFilename, string targetFilename, string description, string workingDirectory, string arguments)
        {
            ...
            return new ShellLnk(linkFilename)
            {
        ...
        public ShellLnk Save(string filename)
        {
